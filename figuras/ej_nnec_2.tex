...
\node (9) [circle, minimum size=17.5pt, fill=orange, line width=1.25pt, draw=black] at (37.5pt, -100.0pt) {\textcolor{black}{9}};
...
\draw [line width=0.625, ->, color=black] (3) to  [in=48, out=188] (9);
\draw [line width=0.625, ->, color=black] (2) to  [in=127, out=217] (12);
\draw [line width=0.625, ->, color=black] (7) to  [in=254, out=4] (14);
\draw [line width=0.625, ->, color=black] (8) to  [in=148, out=86] (14);
\draw [line width=0.625, ->, color=black] (11) to  [in=203, out=307] (13);
\draw [line width=0.625, ->, color=black] (9) to  [in=217, out=274] (13);
