...
\node (6) [circle, minimum size=18.75pt, fill=teal, line width=1.25pt, draw=black] at (250.0pt, -112.5pt) {\textcolor{black}{6}};
...
\draw [line width=1.25, ->, color=black] (7) to  [in=180, out=292] (6);
\draw [line width=1.25, ->, color=black] (6) to  [in=345, out=215] (4);
\draw [line width=1.25, ->, color=black] (1) to  [in=153, out=4] (7);
\draw [line width=1.25, ->, color=black] (6) to  [in=7, out=105] (7);
\draw [line width=1.25, ->, color=black] (5) to  [in=205, out=353] (7);
\draw [line width=1.25, ->, color=black] (4) to  [in=223, out=11] (7);
\draw [line width=1.25, ->, color=black] (2) to  [in=120, out=60] (7);
\draw [line width=1.25, ->, color=black] (3) to  [in=259, out=317] (7);
\end{tikzpicture}
