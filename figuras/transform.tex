...
\node (4) [circle, minimum size=16.25pt, fill=yellow, line width=1.25pt, draw=black,label=right:$\color{red} 1$] at (112.5pt, -137.5pt) {\textcolor{black}{4}};
...
\node (3) [circle, minimum size=16.25pt, fill=yellow, line width=1.25pt, draw=black,label=left:$\color{red} 0$] at (50.0pt, -125.0pt) {\textcolor{black}{3}};
