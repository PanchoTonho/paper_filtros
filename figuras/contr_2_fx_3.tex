...
\draw [line width=0.625, ->, color=black] (7) to  [in=270, out=20] (6);
\draw [line width=0.625, ->, color=black] (2) to  [in=188, out=28] (6);
\draw [line width=0.625, ->, color=black] (3) to  [in=200, out=50] (6);
\draw [line width=0.625, ->, color=black] (4) to  [in=212, out=82] (6);
\draw [line width=0.625, ->, color=black] (6) to  (9);
\draw [line width=0.625, ->, color=black] (7) to  [in=259, out=318] (10);
\draw [line width=0.625, ->, color=black] (2) to  [in=191, out=4] (10);
\draw [line width=0.625, ->, color=black] (3) to  [in=259, out=318] (10);
\draw [line width=0.625, ->, color=black] (4) to  [in=222, out=11] (10);
