...
\draw [line width=0.625, ->, color=black, loop right] (3) to (3);
\draw [line width=0.625, ->, color=black] (1) to  [in=156, out=312] (4);
\draw [line width=0.625, ->, color=black] (3) to  [in=20, out=232] (2);
\end{tikzpicture}
